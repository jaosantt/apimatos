...
public class CompanyService {
	...
	public Company createCompany(CompanyRequestDTO data) {
		...
		try {
			...
			if(
				!ValidatorUtil.isEmptyOrNullOrBlank(data.stateRegistration()) && 
			...
			if(
				!ValidatorUtil.isEmptyOrNullOrBlank(data.municipalRegistration()) && 
			...
			if(
				!ValidatorUtil.isEmptyOrNullOrBlank(data.phone()) &&
